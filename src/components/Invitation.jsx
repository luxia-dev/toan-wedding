...
export default function Invitation() {
  ...
  return (
    <div className="via-pink-50 to-amber-50 pt-4 px-4">
      <h1 className="great-vibes-title font-bold  text-4xl md:text-6xl lg:text-8xl  text-emerald-700!">
        Trân Trọng Kính Mời
      </h1>
      <div className="inline-flex items-center justify-between w-full md:px-24">
        <Heart className="w-8 h-8 text-rose-400 fill-rose-400 animate-pulse" />
        <Heart className="w-8 h-8 text-rose-400 fill-rose-400 animate-pulse" />
      </div>
      <p className="great-vibes-title text-4xl text-rose-600! italic mx-5">
        {name}
      </p>
      ...
      <motion.div
        ...
        className="pt-8"
      >
        <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-rose-100 mb-8 pb-24">
